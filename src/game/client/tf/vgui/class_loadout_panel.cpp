...
{
	{
		...
		0,	// LOADOUT_POSITION_THROWABLE,
		0,	// LOADOUT_POSITION_THROWABLE2,
		0,	// LOADOUT_POSITION_THROWABLE3,
		0,	// LOADOUT_POSITION_THROWABLE4,
		0,	// LOADOUT_POSITION_LUNCHBOX,
	}
};
...
const LoadoutPanelPositioningInstance g_LoadoutPanelPositioning_Heavy =
{
	{
		1,	// LOADOUT_POSITION_PRIMARY = 0,
		2,	// LOADOUT_POSITION_SECONDARY,
...
const LoadoutPanelPositioningInstance *g_VisibleLoadoutSlotsPerClass[] =
{
	...
	&g_LoadoutPanelPositioning_Heavy,			// TF_CLASS_HEAVYWEAPONS
