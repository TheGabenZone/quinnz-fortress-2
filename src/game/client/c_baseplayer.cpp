...
static ConVar	cl_customsounds ( "cl_customsounds", "1", 1, "Enable customized player sound playback" );
...
BEGIN_RECV_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	RecvPropArray3( RECVINFO_ARRAY( m_szScriptOverlayMaterialArray ), 
	RecvPropString( RECVINFO_ARRAY( m_szScriptOverlayMaterialArray ) ) ),
END_RECV_TABLE()
